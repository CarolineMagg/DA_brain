...
# https://github.com/LynnHo/CycleGAN-Tensorflow-2/blob/1aa6398d918875a1cf25320881d09b7d9f3f63b8/tf2lib/utils/utils.py#L34
########################################################################################################################
import logging
...
class Checkpoint:
    ...
    def restore(self, save_path=None):
        ...
        logging.info("Checkpoint: restore checkpoint of {}".format(save_path))
