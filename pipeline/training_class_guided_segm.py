...
from pipeline.ClassGuidedSegmentation import ClassGuidedSegmentation
...
parser.add_argument('--segm_epoch', dest='segm_epoch', default=0, type=int,
                    help='segm training starting epoch')
...
if __name__ == "__main__":
    ...
    print(f"Training with UNet_ClassGuided.")
    seed = args.seed
    d_step = args.d_step
    ...
    tensorboard_dir = "/tf/workdir/DA_brain/logs/cg_segm_{}/".format(seed)
    checkpoints_dir = "/tf/workdir/DA_brain/saved_models/cg_segm_{}/checkpoints/".format(seed)
    save_model_dir = "/tf/workdir/DA_brain/saved_models/cg_segm_{}".format(seed)
    sample_dir = "/tf/workdir/DA_brain/saved_models/cg_segm_{}/sample_dir/".format(seed)
    ...
    cg_segm.train(epochs=50, data_nr=None, restore=False, step_decay=step_decay)
